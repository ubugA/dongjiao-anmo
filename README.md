...
龙兵按摩_247  2025-07-24 10:54:37  ！！！！最新版
【新增】
1、新增短信+语音提醒服务商对接。
2、新增渠道商关联卡券功能，用户通过扫二维码码进入领券页面（能绑定渠道商和用户的佣金关系）。
3、订单雷达新增客户来源字段展示。
4、订单详情新增来源展示。
5、订单新增备注说明（用于客服对订单追踪，例如：用户不支付的原因）。
6、代理商删除技师，新增一个平台审核功能。
7、平台子账号新增一个根据时间范围查看订单数据规则，已完成和已取消状态的订单3天后客服人员都不可查看。
8、订单超时取消后，后台新增语音播报功能。
9、新增开屏广告功能。
10、新增下单服务，可不选择服务人员功能。
11、新增技师入驻须知功能。
【优化】
1、新增配置开关，优化通过分销链接或分销员二维码方式进入系统，可先查看内容后再登录。
2、佣金记录新增分销员申请时姓名字段展示。
3、优化客服弹窗和企微客服配置为独立菜单栏。
4、优化服务名称和副标题的字数。
5、优化招商加盟背景图，支持自定义功能。
6、首页轮播图和个人中心背景图，显示效果优化为图片顶满到状态栏部分。
7、优化用户下单时，服务结束时间若不在技师接单时间范围内，也支持正常下单。
